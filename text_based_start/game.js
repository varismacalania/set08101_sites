...
const textNodes = [
    {
        ...
        options: [
            {
                text: 'Take goo',
                /* what to do if someone takes the goo, change state of goo to true */
        ...
        options: [
            {
                ...
                /* the option shows if we have the blue goo, else it doesn't */
    ...
    {
        id: 3,
        text: 'After leaving the merchant you start to feel tired and stumble upon a small town next to a ' +
    ...
    {
        id: 4,
        text: 'You are so tired that you fall asleep while exploring the castle and are killed by some ' +
            'terrible monster in your sleep',
        options: [
            {
                text: 'Restart',
                nextText: -1
